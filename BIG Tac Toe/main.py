...
class Main:
    ...
    def on_button_click(self, board_index, index):
        ...
        if self.board[board_index][index] == " ":
            if board_index == self.current_board_index or self.can_go_anywhere:
                ...
                if self.check_winner(board_index):
                    ...
                    self.won_boards[board_index] = True
                    ...
                    print(self.board[board_index]) 
                    self.current_board_index = index
                    self.can_go_anywhere = False
                    self.current_player = "O" if self.current_player == "X" else "X"
                    
                if self.won_boards[self.current_board_index]:
                    self.can_go_anywhere = True
